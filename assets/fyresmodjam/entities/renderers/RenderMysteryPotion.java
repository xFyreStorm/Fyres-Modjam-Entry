package assets.fyresmodjam.entities.renderers;
...
public class RenderMysteryPotion extends Render
{
    ...
    {
        Icon icon = (par1Entity instanceof EntityMysteryPotion) ? this.field_94151_a.getIconFromDamage(par1Entity.getDataWatcher().getWatchableObjectInt(24)) : this.field_94151_a.getIconFromDamage(0);
