...
public class TileEntityPillar extends TileEntity {
	...
	public static String[] blessingDescriptions = {"+25% breaking speed on stone and iron blocks, and +25% damage with pickaxes", "+25% breaking speed on wooden blocks, and +15% damage with axes", "+25% melee damage", "+25% projectile damage", "Attacks will slow enemies", "Enemies have a chance to drop gold nuggets", "While sneaking you are invisble and attacks on enemies with full health do double damage", "You disarm traps 3x as often and have 2x the chance to salvage disarmed traps", "All potions act like wildcard potions", "You can see traps without sneaking", "Take 25% less damage from all sources"/*, "2x healing rate"*/, "Heal 7% of damage dealt to enemies and, in direct sunlight, +20% damage taken and -20% damage dealt", "You don't take fire damage, do +50% damage while on fire, and take damage when wet", "You can breathe underwater"};
