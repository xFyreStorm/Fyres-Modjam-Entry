...
public class TileEntityPillar extends TileEntity {
	...
	public static String[] validBlessings = {"Miner", "Lumberjack", "Warrior", "Hunter", "Swamp", "Thief", "Ninja", "Mechanic", "Alchemist", "Scout", "Guardian"/*, "Healer"*/, "Vampire"};
	public static String[] blessingDescriptions = {"+25% mine speed on stone and iron blocks", "+25% mine speed on wooden blocks", "+25% melee damage", "+25% projectile damage", "Attacks will slow enemies", "Enemies have a chance to drop gold nuggets", "While sneaking you are invisble and attacks on enemies with full health do double damage", "You disarm traps 3x as often and have 2x the chance to salvage disarmed traps", "All potions act like wildcard potions", "You can see traps without sneaking", "Take 25% less damage from all sources"/*, "2x healing rate"*/, "Heal 10% of damage dealt to enemies"};
