...
public class TileEntityPillar extends TileEntity {
	...
	public static String[] blessingDescriptions = {"+25% breaking speed on stone and iron blocks, and +25% damage with pickaxes", "+25% breaking speed on wooden blocks, and +15% damage with axes", "+25% melee damage", "+25% projectile damage", "Attacks will slow enemies", "Enemies have a chance to drop gold nuggets", "While sneaking you are invisble and attacks on enemies with full health do double damage", "@\u00A7ePASSIVE - \u00A7oYou disarm traps 3x as often and have 2x the chance to salvage disarmed traps.@\u00A7eACTIVE - \u00A7oOnce per day, you may disarm and salvage target trap for free.", "All potions act like wildcard potions", "You can see traps without sneaking, but take 25% more damage from traps", "Take 25% less damage from all sources"/*, "2x healing rate"*/, "Heal 7% of damage dealt to enemies and, in direct sunlight, you take 20% more damage and deal 20% less damage", "You don't take fire damage, do +50% damage while on fire, and take damage when wet", "You can breathe underwater", "@\u00A7ePASSIVE - \u00A7oKills are added to berserk counter. (10 max)@\u00A7eACTIVE - \u00A7oTurn on/off berserk mode. While berserk mode is active, you do 40% more damage, and berserk counter ticks down every 2 seconds", "The lower your health, the higher your damage, to a maximum of +40%"};
