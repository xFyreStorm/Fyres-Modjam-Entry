...
import assets.fyresmodjam.blocks.BlockMysteryMushroom;
import assets.fyresmodjam.blocks.BlockPillar;
import assets.fyresmodjam.blocks.BlockTrap;
import assets.fyresmodjam.commands.CommandCurrentBlessing;
import assets.fyresmodjam.commands.CommandCurrentDisadvantage;
import assets.fyresmodjam.commands.CommandCurrentWorldTask;
import assets.fyresmodjam.commands.CommandKillStats;
import assets.fyresmodjam.commands.CommandWeaponStats;
import assets.fyresmodjam.entities.EntityMysteryPotion;
import assets.fyresmodjam.handlers.CommonTickHandler;
import assets.fyresmodjam.handlers.GUIHandler;
import assets.fyresmodjam.handlers.PacketHandler;
import assets.fyresmodjam.items.ItemMysteryMushroom;
import assets.fyresmodjam.items.ItemMysteryPotion;
import assets.fyresmodjam.items.ItemObsidianSceptre;
import assets.fyresmodjam.items.ItemPillar;
import assets.fyresmodjam.items.ItemTrap;
import assets.fyresmodjam.misc.CreativeTabModjamMod;
import assets.fyresmodjam.tileentities.TileEntityPillar;
import assets.fyresmodjam.tileentities.TileEntityTrap;
import assets.fyresmodjam.worldgen.PillarGen;
import assets.fyresmodjam.worldgen.WorldGenMoreDungeons;
import assets.fyresmodjam.worldgen.WorldGenTrapsTowersAndMore;
