...
public class TileEntityPillarRenderer extends TileEntitySpecialRenderer
{
    ...
    public static ResourceLocation[] textures = {new ResourceLocation("fyresmodjam", "textures/blocks/pillar.png"), new ResourceLocation("fyresmodjam", "textures/blocks/pillarActive.png")};
    ...
    public void renderBlockYour(TileEntityPillar tl, World world, int i, int j, int k, Block block)
    {
        ...
        this.tileEntityRenderer.renderEngine.bindTexture(!active ? textures[0] : textures[1]);
